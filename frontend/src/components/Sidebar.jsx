...
export default function Sidebar() {
  ...
  return (
    ...
    >
      {/* Logo area */}
      <div className="flex items-center gap-3 h-16 px-5 border-b border-[var(--color-border-subtle)]">
          ...
          return (
            <button
              ...
              className={`
                ...
                transition-all duration-200 cursor-pointer border-0 w-full text-left
                ${isActive
                  ? 'bg-[var(--color-accent-soft)] text-[var(--color-accent-hover)] shadow-[inset_0_0_0_1px_rgba(108,92,231,0.3)]'
